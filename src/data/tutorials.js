const tutorials = [
  {
    ...
    description:
      "Ven Espíritu Santo Barak con acordes, guitarra, piano, bajo y pistas para ensayar",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Video tutorial de como tocar la canción tu eres rey de Barak, de una forma bien fácil y sencilla. ",
    longDescription:
      "bueno qui esta el video tutorial de como tocar la canción tu eres rey de Barak, de una forma bien fácil y sencilla. 4.C. un lugar de ayuda para los que recién comienzan en su llamado a servir a Dios a trabes de la música",
  ...
  },
  {
    ...
    description:
      "hoy les traigo un tutorial de como tocar la tierra canta de Barak, ",
    longDescription:
      "suuuuper sencilloespero haberme expresado bien y que se entienda,  ",
